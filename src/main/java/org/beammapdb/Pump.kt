...
object Pump{
    ...
    fun <K,V> treeMap(
        ...
        return object: Sink<Pair<K, V>, Unit>(){
            ...
            val nodeSer = org.beammapdb.BTreeMapJava.NodeSerializer(keySerializer, comparator,
            ...
            override fun put(e: Pair<K, V>) {
                ...
                //save node
                val node = org.beammapdb.BTreeMapJava.Node(
                ...
                for(dir in dirStack){
                    ...
                    //save dir node
                    val link = store.preallocate()
                    val dirNode = org.beammapdb.BTreeMapJava.Node(
                            dir.leftEdge + DIR,
                            link,
            ...
            override fun create() {
                //close leaf node
                val endLeaf = org.beammapdb.BTreeMapJava.Node(
                        leftEdgeLeaf + RIGHT,
                        0L,
                        keySerializer.valueArrayFromArray(keys.toArray()),
                        nodeValues()
