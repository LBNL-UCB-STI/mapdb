package org.beammapdb.StoreAccess

import org.beammapdb.StoreDirectAbstract
import org.beammapdb.StoreWAL
import org.beammapdb.Utils
import org.beammapdb.WriteAheadLog
...
val StoreDirectAbstract.maxRecid: Long
    get() = Reflectio.method("getMaxRecid").withReturnType(Long::class.java).`in`(this).invoke()
...
val StoreDirectAbstract.volume: Volume
    get() = Reflection.method("getVolume").withReturnType(org.beammapdb.volume.Volume::class.java).`in`(this).invoke()
