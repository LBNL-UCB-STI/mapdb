...
abstract class SerializerTest<E> {
    ...
    val max = 1000L + org.mapdb.TT.testScale() * 1000*10
    val arraySize = 10 + org.mapdb.TT.testScale() * 100
    ...
    @Test fun cloneEquals(){
        for(i in 0..max){
            val e = randomValue()
            val e2 = org.mapdb.TT.clone(e, serializer, out = dataOutput)
...
abstract class GroupSerializerTest<E>: SerializerTest<E>(){
    ...
    @Test open fun valueArrayBinarySearch(){
        ...
        fun check(keys:Any?, binary:ByteArray, e:E, diPos:Int){
            ...
            assertEquals(v1, v3);
            assertEquals(v1, v2);
            val di = org.mapdb.DataInput2.ByteArray(binary);
        ...
        val deserialized = serializer2.valueArrayDeserialize(org.mapdb.DataInput2.ByteArray(out.buf), v.size);
        val diPos = out.pos
    ...
    @Test open fun valueArrayGet(){
        ...
        for(i in 0 until max.toInt()){
            ...
            val v3 = serializer2.valueArrayBinaryGet(org.mapdb.DataInput2.ByteArray(out.buf), max.toInt(), i)
    ...
    fun cloneValueArray(vals:Any?):Any?{
        ...
        val input = org.mapdb.DataInput2.ByteArray(out.buf)
    ...
    @Test fun btreemap(){
        ...
        val map = org.mapdb.BTreeMap.Companion.make(keySerializer = ser, valueSerializer = Serializer.INTEGER)
        val set = TreeSet(ser);
        for(i in 1..100)
...
class Serializer_STRINGXXHASH: GroupSerializerTest<String>(){
    override fun randomValue() = org.mapdb.TT.randomString(random.nextInt(10))
...
class Serializer_BYTE_ARRAY: GroupSerializerTest<ByteArray>(){
    override fun randomValue() = org.mapdb.TT.randomByteArray(random.nextInt(50))
...
class Serializer_CHAR_ARRAY: GroupSerializerTest<CharArray>(){
    ...
    @Test fun prefix_submap(){
        val map = org.mapdb.BTreeMap.Companion.make(keySerializer = serializer, valueSerializer = Serializer.STRING)
...
class Serializer_JAVA: GroupSerializerTest<Any>(){
    override fun randomValue() = org.mapdb.TT.randomString(10)
    ...
    @Test fun clone1(){
        val v = org.mapdb.TT.clone(Object2(), Serializer.JAVA)
        assertTrue(v is Object2)
    }

    @Test fun clone2(){
        val v = org.mapdb.TT.clone(CollidingObject("111"), Serializer.JAVA)
        assertTrue(v is CollidingObject)
        assertSerEquals("111", (v as CollidingObject).value)
    }

    @Test fun clone3(){
        val v = org.mapdb.TT.clone(ComparableCollidingObject("111"), Serializer.JAVA)
...
class Serializer_ELSA: GroupSerializerTest<Any>(){
    ...
    @Test fun clone1(){
        val v = org.mapdb.TT.clone(Object2(), Serializer.ELSA)
        assertTrue(v is Object2)
    }

    @Test fun clone2(){
        val v = org.mapdb.TT.clone(CollidingObject("111"), Serializer.ELSA)
        assertTrue(v is CollidingObject)
        assertSerEquals("111", (v as CollidingObject).value)
    }

    @Test fun clone3(){
        val v = org.mapdb.TT.clone(ComparableCollidingObject("111"), Serializer.ELSA)
        assertTrue(v is ComparableCollidingObject)
        assertSerEquals("111", (v as ComparableCollidingObject).value)
...
class Serializer_DB_default: GroupSerializerTest<Any?>(){
    override fun randomValue() = org.mapdb.TT.randomString(11)
    override val serializer = org.mapdb.DBMaker.memoryDB().make().defaultSerializer
...
class SerializerCompressionWrapperTest(): GroupSerializerTest<ByteArray>(){
    override fun randomValue() = org.mapdb.TT.randomByteArray(random.nextInt(1000))

    override val serializer = SerializerCompressionWrapper(org.mapdb.Serializer.BYTE_ARRAY as GroupSerializer<ByteArray>)

    @Test
    fun compression_wrapper() {
        var b = ByteArray(100)
        Random().nextBytes(b)
        assertTrue(org.mapdb.Serializer.BYTE_ARRAY.equals(b, org.mapdb.TT.clone(b, serializer)))
...
class Serializer_DeflateWrapperTest(): GroupSerializerTest<ByteArray>() {
    override fun randomValue() = org.mapdb.TT.randomByteArray(random.nextInt(1000))
    override val serializer = SerializerCompressionDeflateWrapper(org.mapdb.Serializer.BYTE_ARRAY as GroupSerializer<ByteArray>)


    @Test fun deflate_wrapper() {
        val c = SerializerCompressionDeflateWrapper(org.mapdb.Serializer.BYTE_ARRAY  as GroupSerializer<ByteArray>, -1,
        ...
        assertTrue(Arrays.equals(b, org.mapdb.TT.clone(b, c)))
    }
...
open class Serializer_Array(): GroupSerializerTest<Array<Any>>(){
    override fun randomValue() = Array<Any>(random.nextInt(30), { org.mapdb.TT.randomString(random.nextInt(30)) })

    override val serializer = SerializerArray(org.mapdb.Serializer.STRING as Serializer<Any>)

    @Test fun array() {
        val s: Serializer<Array<Any>> = SerializerArray(org.mapdb.Serializer.INTEGER as Serializer<Any>)

        val a:Array<Any> = arrayOf(1, 2, 3, 4)

        assertTrue(Arrays.equals(a, org.mapdb.TT.clone(a, s)))
    }
...
class Serializer_DeltaArray(): Serializer_Array(){
    ...
    override val serializer = SerializerArrayDelta(org.mapdb.Serializer.STRING as Serializer<Any>)
...
class Serializer_ArrayTuple(): GroupSerializerTest<Array<Any>>(){
    ...
    override val serializer = SerializerArrayTuple(org.mapdb.Serializer.INT_ARRAY, Serializer.LONG_ARRAY)


    @Test fun prefix_submap(){
        val map = org.mapdb.BTreeMap.Companion.make(keySerializer = SerializerArrayTuple(org.mapdb.Serializer.INTEGER, Serializer.LONG), valueSerializer = Serializer.STRING)
    ...
    @Test fun prefix_comparator(){
        val s = SerializerArrayTuple(org.mapdb.Serializer.INTEGER, Serializer.INTEGER)
...
class SerializerUtilsTest(){
    @Test fun lookup(){
        assertEquals(org.mapdb.Serializer.LONG, SerializerUtils.serializerForClass(Long::class.java))
        assertEquals(org.mapdb.Serializer.LONG_ARRAY, SerializerUtils.serializerForClass(LongArray::class.java))
        assertEquals(org.mapdb.Serializer.UUID, SerializerUtils.serializerForClass(UUID::class.java))
        assertEquals(org.mapdb.Serializer.STRING, SerializerUtils.serializerForClass(String::class.java))
        assertNull(org.mapdb.serializer.SerializerUtils.serializerForClass(org.mapdb.Serializer::class.java))
    }
