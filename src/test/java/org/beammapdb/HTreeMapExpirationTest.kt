...
class HTreeMapExpirationTest {
    ...
    @Test(timeout = 10000)
    fun expire_create() {
        val map: HTreeMap<Int, String> = org.mapdb.HTreeMap.Companion.make(expireCreateTTL = 1000, concShift = 0)
    ...
    @Test(timeout = 10000)
    fun expire_update() {
        val map: HTreeMap<Int, String> = org.mapdb.HTreeMap.Companion.make(expireUpdateTTL = 1000, concShift = 0)
    ...
    @Test(timeout = 10000)
    fun expire_get() {
        val map: HTreeMap<Int, String> = org.mapdb.HTreeMap.Companion.make(expireGetTTL = 1000, concShift = 0)
    ...
    @Test(timeout = 10000)
    fun instant_create() {
        val map: HTreeMap<Int, String> = org.mapdb.HTreeMap.Companion.make(expireCreateTTL = 1, concShift = 0)
        map.put(1, "aa")
        Thread.sleep(100)
        map.expireEvict()
        assertNull(map[1]);
    ...
    @Test(timeout = 10000)
    fun instant_update() {
        val map: HTreeMap<Int, String> = org.mapdb.HTreeMap.Companion.make(expireUpdateTTL = 1, concShift = 0)
    ...
    @Test(timeout = 10000)
    fun instant_get() {
        val map: HTreeMap<Int, String> = org.mapdb.HTreeMap.Companion.make(expireGetTTL = 1, concShift = 0)
        map.put(1, "aa")
        assertEquals("aa", map[1])
        Thread.sleep(100)
        map.expireEvict()
    ...
    fun concurrentExpire() {
        val map: HTreeMap<Int, Int> = org.mapdb.HTreeMap.Companion.make(expireCreateTTL = 300, concShift = 4,
                valueSerializer = Serializer.INTEGER, keySerializer = Serializer.INTEGER)

        val size = 10000
        org.mapdb.TT.fork(16) {
            val r = Random()
    ...
    fun concurrentExpire_update() {
        val map: HTreeMap<Int, Int> = org.mapdb.HTreeMap.Companion.make(expireUpdateTTL = 300, concShift = 4,
                valueSerializer = Serializer.INTEGER, keySerializer = Serializer.INTEGER)
    ...
    fun concurrentExpire_get() {
        val map: HTreeMap<Int, Int> = org.mapdb.HTreeMap.Companion.make(expireGetTTL = 300, concShift = 4,
                valueSerializer = Serializer.INTEGER, keySerializer = Serializer.INTEGER)
    ...
    fun background_expiration(){
        val map = org.mapdb.HTreeMap.Companion.make(expireCreateTTL = 300, concShift = 4,
                valueSerializer = Serializer.INTEGER, keySerializer = Serializer.INTEGER,
    ...
    @Test(timeout = 100000)
    fun maxSize(){
        val map = org.mapdb.DBMaker.memoryDB().make()
    ...
    @Test fun expireStoreSize(){
        ...
        val db = org.mapdb.DBMaker.volumeDB(volume, false)
                .make()
