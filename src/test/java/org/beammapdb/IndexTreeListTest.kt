...
import org.beammapdb.IndexTreeListJava.*;
import java.util.*
...
//    }
    ...
    @Test fun dirSer(){
        ...
        var dir = IndexTreeListJava.dirEmpty()
        for(i in 0 ..max step 10) {
            assertArrayEquals(dir, org.mapdb.TT.clone(dir, dirSer))
            dir = IndexTreeListJava.dirPut(dir, i, i * 10L, i * 100L)
        }
        assertArrayEquals(dir, org.mapdb.TT.clone(dir, dirSer))
...
//TODO zero value is allowed, check in iterations etc
    @Test fun treeGet(){
        ...
        for(binary in org.mapdb.TT.bools) {
            ...
            val store = if(binary) org.mapdb.StoreDirect.Companion.make() else StoreTrivial();
    ...
    @Test fun treeRandom(){
        ...
        val root = s.put(org.mapdb.IndexTreeListJava.dirEmpty(), dirSer);
    ...
    @Test fun treeClear(){
        ...
        //create tree
        val rootRecid = store.put(org.mapdb.IndexTreeListJava.dirEmpty(), IndexTreeListJava.dirSer)
