...
class VolumeCrashTest(): CrashJVM(){
    ...
    @Test
    fun fileChannel() {
        org.mapdb.crash.CrashJVM.Companion.run(this, time = TT.testRuntime(10), params = "fileChannel")
    }

    @Test
    fun raf() {
        org.mapdb.crash.CrashJVM.Companion.run(this, time = TT.testRuntime(10), params = "raf")
    }

    @Test
    fun mapped() {
        org.mapdb.crash.CrashJVM.Companion.run(this, time = TT.testRuntime(10), params = "mapped")
    }

    @Test
    fun mappedSingle() {
        org.mapdb.crash.CrashJVM.Companion.run(this, time = TT.testRuntime(10), params = "mappedSingle")
    }
}