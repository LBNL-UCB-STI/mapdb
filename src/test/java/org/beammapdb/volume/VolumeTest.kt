...
class VolumeTest {
    ...
    companion object {
        ...
        internal val BYTE_ARRAY_FAB:Function1<String, Volume> = { file -> ByteArrayVol(org.mapdb.CC.PAGE_SHIFT, 0L) }
    ...
    @Test fun direct_bb_overallocate() {
        ...
        } catch (e: org.mapdb.DBException.OutOfMemory) {
    ...
    @Test fun byte_overallocate() {
        ...
        val vol = ByteArrayVol(org.mapdb.CC.PAGE_SHIFT, 0L)
        try {
            vol.ensureAvailable(1e10.toLong())
        } catch (e: org.mapdb.DBException.OutOfMemory) {
    ...
    fun lock_double_open() {
        ...
        try {
            ...
            fail()
        } catch (l: org.mapdb.DBException.FileLocked) {
            //ignored
        }
    ...
    fun testClearOverlap2() {
        ...
        clearOverlap(org.mapdb.CC.PAGE_SIZE, 10000000)
        clearOverlap(org.mapdb.CC.PAGE_SIZE - 1, CC.PAGE_SIZE * 3)
        clearOverlap(org.mapdb.CC.PAGE_SIZE + 1, CC.PAGE_SIZE * 3)
    }
