...
import org.beammapdb.jsr166Tests.ConcurrentSkipListMapTest
import java.util.*
...
class SortedTableMap_ConcurrentSkipListMapTest_JSR166Test() : ConcurrentSkipListMapTest()
{
    ...
    override fun map5(): ConcurrentNavigableMap<*, *>? {
        ...
        consumer.put(Pair(org.mapdb.jsr166Tests.JSR166TestCase.one, "A"))
        consumer.put(Pair(org.mapdb.jsr166Tests.JSR166TestCase.two, "B"))
        consumer.put(Pair(org.mapdb.jsr166Tests.JSR166TestCase.three, "C"))
        consumer.put(Pair(org.mapdb.jsr166Tests.JSR166TestCase.four, "D"))
        consumer.put(Pair(org.mapdb.jsr166Tests.JSR166TestCase.five, "E"))
