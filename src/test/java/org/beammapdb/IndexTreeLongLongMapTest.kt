...
import org.beammapdb.indexTreeLongLongMapTests_GS_GENERATED.*
...
class IndexTreeLongLongMapTest{
    ...
    @Test fun defaultSize(){
        ...
        val maxSize = Math.pow(1L.shl(org.mapdb.CC.INDEX_TREE_LONGLONGMAP_DIR_SHIFT).toDouble(), CC.INDEX_TREE_LONGLONGMAP_LEVELS.toDouble())
        val expected = 100L * 1024*1024
        assertTrue(maxSize> expected)
        val map = org.mapdb.IndexTreeLongLongMap.Companion.make()
    ...
    class GSHashMapTest(): AbstractMutableLongLongMapTestCase(){
        ...
        override fun getEmptyMap(): MutableLongLongMap? {
            return org.mapdb.IndexTreeLongLongMap.Companion.make()
        }

        override fun newWithKeysValues(key1: Long, value1: Long): MutableLongLongMap? {
            val ret = org.mapdb.IndexTreeLongLongMap.Companion.make()
            ret.put(key1, value1);
            return ret
        }
    ...
    class GSLongLongHashMapKeySetTest: LongLongHashMapKeySetTest(){
        ...
        override fun classUnderTest(): MutableLongSet {
            val v = org.mapdb.IndexTreeLongLongMap.Companion.make()
            v.put(1L,1L)
            v.put(2L,2L)
            v.put(3L,3L)
            return v.keySet()
    ...
    class GSLongLongHashMapKeysViewTest : AbstractLazyLongIterableTestCase(){
        ...
        override fun getEmptyIterable(): LazyLongIterable? {
            return org.mapdb.IndexTreeLongLongMap.Companion.make().keysView()
        }
    ...
    @Test fun concurrent_modification() {
        ...
        concModTest(org.mapdb.IndexTreeLongLongMap.Companion.make(collapseOnRemove = true))
    }
    ...
    @Test fun concurrent_modification2() {
        ...
        concModTest(org.mapdb.IndexTreeLongLongMap.Companion.make(collapseOnRemove = false))
    }
